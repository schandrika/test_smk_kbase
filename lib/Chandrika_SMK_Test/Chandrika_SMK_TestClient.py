...
class Chandrika_SMK_Test(object):
    ...
    def query_smk(self, query_input_fn_param, context=None):
        """
        ...
        return self._client.call_method(
            'Chandrika_SMK_Test.query_smk',
            [query_input_fn_param], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('Chandrika_SMK_Test.status',
