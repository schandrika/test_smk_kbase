...
function Chandrika_SMK_Test(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.query_smk = function (query_input_fn_param, _callback, _errorCallback) {
        if (typeof query_input_fn_param === 'function')
            throw 'Argument query_input_fn_param can not be a function';
        ...
        return json_call_ajax(_url, "Chandrika_SMK_Test.query_smk",
            [query_input_fn_param], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "Chandrika_SMK_Test.status",
